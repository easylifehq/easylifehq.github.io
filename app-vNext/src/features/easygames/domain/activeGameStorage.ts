...
export function canReplaceActiveGame(state: { revision: number; status: string; }, confirmReplacement: () => boolean) { return !hasMeaningfulProgress(state) || confirmReplacement(); }
