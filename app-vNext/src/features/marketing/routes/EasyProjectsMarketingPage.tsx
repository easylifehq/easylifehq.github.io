      ...
      features={[
        {
          ...
          description: "Break a goal into areas so the next action is easier to find.",
        },
        {
          tag: "Connection",
        ...
        {
          tag: "Planning",
          title: "Review-first project drafts",
          description: "AI can suggest a project plan, but it stays editable before anything becomes real data.",
        },
      ]}
      stepsTitle="Plan the bigger thing without overbuilding it"
      steps={[
        {
          title: "Create the project",
          description: "Name the goal and keep the rough purpose visible.",
        },
        {
          title: "Add sections and tasks",
          description: "Organize the work into practical parts with linked task follow-through.",
        },
        {
          title: "Use the timeline",
          description: "Review project timing and keep the next pieces moving.",
        },
      ]}
