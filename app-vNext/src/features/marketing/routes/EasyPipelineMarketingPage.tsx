...
export function EasyPipelineMarketingPage() {
  return (
    <ProductMarketingPage
      ...
      featuresDescription="Track momentum, see what needs follow-up, and keep the process from turning into a fog."
      features={[
        {
          tag: "Board",
          title: "Clear pipeline stages",
          description: "See what still needs an application, what is waiting, and what needs outreach next.",
        },
        {
          tag: "Follow-up",
          title: "Stay consistent",
          description: "Keep important leads from going cold and make your next actions visible.",
        },
        {
          tag: "Contacts",
      ...
      steps={[
        {
          title: "Log each opportunity",
          description: "Capture the role, company, and stage so you stop relying on memory alone.",
        },
        {
          title: "See the next move clearly",
          description: "Know which applications still need work and which ones need a follow-up.",
        },
        {
          title: "Keep momentum visible",
          description: "Use the board to stay consistent instead of letting the search blur together.",
        },
      ]}
