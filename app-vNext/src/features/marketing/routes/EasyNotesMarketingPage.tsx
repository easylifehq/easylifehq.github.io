...
export function EasyNotesMarketingPage() {
  return (
    <ProductMarketingPage
      ...
      heroDescription="Notes is for brain dumps, meeting notes, rough drafts, and fast thought capture with a calm mobile-first writing experience."
      heroPoints={["Mobile-friendly", "Clean note list", "Minimal formatting", "Draft handoff to Inbox"]}
      ...
      heroPreviewItems={[
        ...
        { app: "Inbox handoff", detail: "3 action lines queued" },
      ]}
      ...
      features={[
        ...
        {
          tag: "Action",
          title: "Turn ideas into task drafts",
      ...
      steps={[
        ...
        {
          title: "Send action items to task drafts",
      ...
      ctaBody="Use Notes when you want a clean place to think on mobile without turning every note into a project."
      demoPath={[
        {
        ...
        },
        {
          ...
          description: "Use a rough note to create task drafts for review.",
        },
        {
          title: "Make a project",
          description: "Send a note outline into Projects when the note grows bigger.",
        },
      ]}
    />
  );
