...
- [ ] Docs cleanup: improve docs/codex/TASK_BOARD.md or docs/codex/LOOP.md so the Codex workflow is clearer. Do not touch app code for this task.
...
3. Let the outer PowerShell loop run the app-vNext build.
4. Review the diff for bugs, broken mobile behavior, and scope creep.
5. Fix issues found during review.
6. Only mark the task complete if the final external build passes.
7. Append notes to docs/codex/NIGHTLY_REPORT.md on the practice branch.
