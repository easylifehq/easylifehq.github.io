...
- [YELLOW] `app-vNext/src/features/hq/routes/HQPage.tsx:397` - Icon-style button may need an accessible label.
...
- [INFO] `app-vNext/src/styles/globals.css:10913` - Reduced-motion handling is present.
