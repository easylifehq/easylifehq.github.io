...
- [YELLOW] `app-vNext/src/features/hq/routes/HQPage.tsx:353` - Icon-style button may need an accessible label.
...
- [INFO] `app-vNext/src/styles/globals.css:10831` - Reduced-motion handling is present.
