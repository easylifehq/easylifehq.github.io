...
Showable Moment: Persistent Capture opens on one raw Inbox field and explicit save action, with structured capture types available only after deliberate disclosure.
...
Updated At: 2026-07-17 - P4.5-01 Today action collision, P4.5-02 Inbox capability-control hierarchy, and P4.5-03 raw-first persistent Capture are complete. P4.5 remains active; P4.5-04 Notes write-first hierarchy is next. P5 live AI and true push remain paused behind explicit approval.
